...
class _MotivasiAllState extends State<MotivasiAll> {
  ...
  print("Response data: ${response.data}"); // Tambahkan log ini
  if (response.statusCode == 200) {
                                            ...
                                            children: [
                                              ...
                                              FutureBuilder(
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  if (snapshot.hasData) {
                                                    var isLiked = (snapshot.data?.likes != null && int.parse(snapshot.data?.likes ?? '0') > 0) ? true : false;
                                                        ...
                                                        return LikeButton(
                                                          ...
                                                          likeBuilder: (bool isCurrentlyLiked) {
                                                            return Icon(
                                                              ...
                                                              color: isLiked ? Colors.red : Colors.grey, // Pastikan warna merah untuk like
                                                              size: 20,
                                                            );
                                                          },
                                                          likeCount: count,
                                                          ...
                                                          onTap: (bool isCurrentlyLiked) async {
                                                            await putLike(widget.idUser ?? '', item.id ?? '').then((value) {
                                                              if (value != '') {
                                                    ...
                                                    return LikeButton(
                                                      ...
                                                      likeBuilder: (bool isCurrentlyLiked) {
                                                        return Icon(
                                                          CupertinoIcons.heart_fill,
                                                          color: isCurrentlyLiked ? Colors.red : Colors.grey, // Pastikan warna merah untuk like
                                                          size: 20,
                                                        );
                                                      },
                                                      ...
                                                      onTap: (bool isCurrentlyLiked) async {
                                                        ...
                                                        setState(() {
                                                          ...
                                                          bool isLiked = !isCurrentlyLiked; // Deklarasikan isLiked di dalam setState
